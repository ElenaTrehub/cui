                ...
                <div className="uk-modal-dialog uk-modal-body">
                    ...
                    <form>
                        <div className="uk-margin">
                            <input data-title className="uk-input" type="text" placeholder="Title" value={title} onChange={(e) => this.onValueChange(e)}/>
                        </div>
                        <div className="uk-margin">
                            <textarea data-key  onChange={(e) => this.onValueChange(e)} className="uk-textarea" rows="5" placeholder="Keywords" value={keywords ? keywords : ''}></textarea>
                        </div>
                        <div className="uk-margin">
                            <textarea onChange={(e) => this.onValueChange(e)} data-description className="uk-textarea" rows="5" placeholder="Description" value={description ? description : ''}></textarea>
                        </div>
                    </form>
                    ...
                    <p className="uk-text-right">
                        ...
                        <button
                            ...
                            type="button" onClick={() => this.applayMeta()}>Применить</button>
                    </p>
                </div>
            </div>
        )
